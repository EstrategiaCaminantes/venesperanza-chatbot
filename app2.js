    ...
    connection.query(sql, (error, results) => {
      ...
      if (results.length > 0) { 
        ...
        if(!$conversation.conversation_start){
          ...
          //va a responder pregunta en llenar nuevo formulario 
          //const sql = `SELECT * FROM encuesta where waId = '${whatsappID}'`;
          
        //cuando existe conversacion CHATBOT conversation_start = 1
  ...
  async function seleccionarFormulario(conversation){
    ...
    try {
        switch (req.body.Body) {
            ...
            case '1':
              console.log('ENTRA A CASO 1??');
              console.log('mensajeRespuesta en caso 1::',mensajeRespuesta);
            ...
            case '2':
              //crea actualizar datos
                ...
                mensajeRespuesta = 'Empieza Reportar llegada';
      ...
      if (conversation.encuesta_chatbot == true) {
          ...
          if (conversation.pregunta == null) {
            ...
            switch (conversation.pregunta) {
                  ...
                  if (req.body.Body === '7') {
                    ...
                    switch (req.body.Body) {
                      case '1':
                        ...
                        crearEncuesta(conversation);
                        mensajeRespuesta = '*Número de Documento:*. Sí no sabe el número de documento, envía "." (punto)';
                      ...
                      case '2':
                        ...
                        conversation.pregunta += 2;// pregunta 21
                        crearEncuesta(conversation);
                        mensajeRespuesta = '*Número de Documento:*. Sí no sabes el número de documento, envías "." (punto)';
                        break;
              ...
              case 21:
                try {
                  conversation.numero_documento = req.body.Body.replace(/[^\ñ\Ñ\ü\Ü\á\Á\é\É\í\Í\ó\Ó\ú\Ú\-\w]/gi, '');
              ...
              case 34:
                console.log('PREGUNTA 34');
                try {
                  var valoresAceptados = /^[1-9]/;
                  console.log('BODY EN 34 TOTAL MIEMBORS ACOMPAÑAN:: ', req.body.Body);
                  if ((req.body.Body.length >= 1 && req.body.Body.length <= 2 && req.body.Body >= 1  ) && (req.body.Body.match(valoresAceptados))) {
                    ...
                    conversation.total_miembros_hogar = 1;
                    conversation.paso_chatbot =  3;
                    conversation.pregunta = 49; //Va a pregunta 49 paso 3
                    crearEncuesta(conversation);
                ...
                try {
                  switch (req.body.Body) {
                    case '1':
                      ...
                      crearEncuesta(conversation);
                      mensajeRespuesta = "Envía el Número de Contacto VenEsperanza. (Solamente ingresa números. El tamaño de carácteres debe ser mínimo 7 y máximo 10):";
                      break;
                    ...
                    case '2':
                      ...
                      crearEncuesta(conversation);
                      mensajeRespuesta = "Envía el Número de Contacto principal. (Solamente ingresa números. El tamaño de carácteres debe ser mínimo 7 y máximo 10):";
                      break;
                ...
                try {
                  ...
                  if ($numero.toString().length >= 7 && $numero.toString().length <= 10) {
                    ...
                    if (conversation.numero_entregado_venesperanza == true) {
                      ...
                      mensajeRespuesta = "Envía el Número de Contacto VenEsperanza. (Solamente ingrese números. El tamaño de carácteres debe ser mínimo 7 y máximo 10):";

                    } else if (conversation.numero_entregado_venesperanza == false) {

                      mensajeRespuesta = "Envía el Número de Contacto principal. (Solamente ingrese números. El tamaño de carácteres debe ser mínimo 7 y máximo 10):";
                ...
                try {
                  ...
                  switch (req.body.Body) {
                    case '1':
                      ...
                      crearEncuesta(conversation);
                      mensajeRespuesta = "Envía el Número de Contacto alternativo. (Solamente ingrese números. El tamaño de carácteres debe ser mínimo 7 y máximo 10):";
                      break;
              ...
              case 65:
                ...
                try {
                  conversation.otra_forma_contactarte = req.body.Body.replace(/[^\ñ\Ñ\ü\Ü\á\Á\é\É\í\Í\ó\Ó\ú\Ú\@\.\-\/\_\#\w\s]/gi, '');
